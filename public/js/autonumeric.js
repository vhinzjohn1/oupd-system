        ...
        (() => {
                    ...
                    (s = [
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                return (
                                    this.isWheelEvent(e) &&
                                    !this.isUndefinedOrNullOrEmpty(e.deltaY) &&
                                    0 === e.deltaY
                                );
                            },
                        },
                    ...
                    return (
                        ...
                        (i = [
                            ...
                            },
                            {
                                key: "_getParentForm",
                                value: function () {
                                    if (!h.isUndefined(this.domElement.form))
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    h.isWheelUpEvent(e)
                                        ...
                                        ? (i = !0)
                                        : h.isWheelEventWithZeroDeltaY(e)
                                        ? (n = !0)
                                        : h.throwError(
                        ...
                        (a = [
                                ...
                                value: function (t) {
                                    ...
                                    h.isTrueOrFalseString(
                                        ...
                                        h.isInArray(a.digitalGroupSpacing, [
                                            ...
                                            h.throwError(
                                                "The grouping separator option for thousands 'digitalGroupSpacing' is invalid ; it should be '2', '2t', '2s', '3', or '4', [".concat(
                            ...
                            },
                            {
                                ...
                                value: function (t, i, n, a) {
                                    ...
                                    var s = h.isZeroOrHasNoValue(t);
                                    r && (t = t.replace("-", ""));
                                    var l,
                                        u = F(t.split(i.decimalCharacter), 2),
                                        c = u[0],
                                        m = u[1];
                                    if (
            ...
            (z.maximumValue = 0),
                (z.negativePositiveSignPlacement =
                    M.options.negativePositiveSignPlacement.prefix);
            var W = h.cloneObject(R);
            W.digitGroupSeparator = M.options.digitGroupSeparator.normalSpace;
            ...
            ($.maximumValue = 0),
                ($.negativePositiveSignPlacement =
                    M.options.negativePositiveSignPlacement.prefix);
            var Y = h.cloneObject(Z);
            Y.decimalPlaces = 3;
            var J = h.cloneObject(q);
            J.decimalPlaces = 3;
            var X = h.cloneObject($);
            (X.decimalPlaces = 3),
                (h.cloneObject(U).formulaMode = M.options.formulaMode.enabled);
            var Q = h.cloneObject(U);
            Q.minimumValue = 0;
