!(function (t, n) {
            ...
            t: if ("function" == typeof E) {
                if (
                    ...
                    null != c.componentWillUpdate &&
                        c.componentWillUpdate(v, c.__s, y),
    ...
    function W(t, n, e) {
        ...
        if (
            ...
            (r = t.ref) &&
                ((r.current && r.current !== t.__e) || U(r, null, n)),
            null != (r = t.__c))
        ) {
    ...
    var K,
        X = /*#__PURE__*/ (function (t) {
            function n(n) {
                var e;
                return (
                    ((e = t.call(this) || this).data = void 0), e.update(n), e
                );
            }
            o(n, t);
            var e = n.prototype;
        ...
        Z = /*#__PURE__*/ (function (t) {
            function n(n) {
                var e;
                return (
                    ((e = t.call(this) || this)._cells = void 0),
                    (e.cells = n || []),
                    e
                );
            }
        ...
        J = /*#__PURE__*/ (function (t) {
            function n(n) {
                ...
                return (
                    ...
                    (e._length = void 0),
                    (e.rows =
                        n instanceof Array ? n : n instanceof Z ? [n] : []),
                    e
                );
            }
            return (
                ...
                (n.off = function (t, n) {
                    ...
                    return (
                        ...
                        this.callbacks[e] && 0 !== this.callbacks[e].length
                            ? ((this.callbacks[e] = this.callbacks[e].filter(
                                  function (t) {
                                      return t != n;
                                  }
                              )),
    ...
    function It() {
        return (function (t) {
            ...
            return (
                (e.c = t),
                n
                    ? (null == e.__ && ((e.__ = !0), n.sub(it)), n.props.value)
                    : t.__
            );
        })(fn);
    }
                    ...
                    r(
                        i.server
                            ...
                            : new nt({
                                  ...
                                  ignoreHiddenColumns:
                                      i.ignoreHiddenColumns ||
                                      void 0 === i.ignoreHiddenColumns,
                                  selector: i.selector,
                              })
                    ),
    ...
    function Ft() {
        ...
        var C = function (t) {
                m &&
                    t !== v.current &&
                    (b(0),
                    0 !== v.current.props.page &&
                        v.current.setProps({ page: 0 }));
            },
            E = function () {
    ...
    var $t = /*#__PURE__*/ (function () {
        ...
        return (
            ...
            (n.remove = function (t) {
                var n = this.get(t);
                return (
                    n && this.plugins.splice(this.plugins.indexOf(n), 1), this
                );
            }),
            (n.list = function (t) {
                var n;
    ...
    function Gt(t) {
        ...
        if (t.pluginId) {
            ...
            return o
                ? x(P, {}, x(o.component, r({ plugin: o }, t.props)))
                : null;
        }
    ...
    var Kt = /*#__PURE__*/ (function (n) {
            function i() {
                var t;
                return (
                    ((t = n.call(this) || this)._columns = void 0),
                    (t._columns = []),
                    t
                );
            }
                ...
                (i.fromColumns = function (t) {
                    for (var n, e = new i(), r = a(t); !(n = r()).done; ) {
                        ...
                        if ("string" == typeof o || d(o))
                            e.columns.push({ name: o });
                        else if ("object" == typeof o) {
                            var u = o;
                            u.columns &&
                                (u.columns = i.fromColumns(u.columns).columns),
                    ...
                    return (
                        t.from
                            ...
                            : !t.data ||
                              ...
                              (n.columns = Object.keys(t.data[0]).map(function (
                                  t
                              ) {
                                  return { name: t };
                              })),
                ...
                (i.fromHTMLTable = function (t) {
                    for (
                        var n,
                            e = new i(),
                            r = a(
                                t.querySelector("thead").querySelectorAll("th")
                            );
                        !(n = r()).done;
                    ...
                    if (e && e.length)
                        for (var r, o = a(e); !(r = o()).done; ) {
                            ...
                            (i.columns && 0 !== i.columns.length) || n.push(i),
                                i.columns &&
                                    (n = n.concat(this.leafColumns(i.columns)));
                        }
                    return n;
                }),
        ...
        Jt = /*#__PURE__*/ (function (t) {
            function n(n) {
                var e;
                return (
                    ((e = t.call(this) || this).options = void 0),
                    (e.options = n),
                    e
                );
            }
                ...
                (t.tableElementToArray = function (t) {
                    for (
                        var n,
                            ...
                            r = [],
                            o = a(
                                t.querySelector("tbody").querySelectorAll("tr")
                            );
                        !(n = o()).done;
                        ...
                        for (
                            var i,
                                u = [],
                                s = a(n.value.querySelectorAll("td"));
                            !(i = s()).done;
    ...
    var rn = /*#__PURE__*/ (function (t) {
            ...
            return (
                ...
                (r.register = function (t, n) {
                    ...
                    if (this.findProcessorIndexByID(t.id) > -1)
                        throw Error(
                            "Processor ID " + t.id + " is already defined"
                        );
                    return (
                        t.on(
                            "propsUpdated",
                            this.processorPropsUpdated.bind(this)
                        ),
                ...
                e(n, [
                    {
                        ...
                        get: function () {
                            for (
                                var t,
                                    n = [],
                                    e = a(this.getSortedProcessorTypes());
                                !(t = e()).done;
                ...
                (t.createFromConfig = function (t) {
                    ...
                    return (
                        t.storage instanceof Jt &&
                            n.register(
                                new sn({ serverStorageOptions: t.server })
                            ),
            ...
            (this.state = void 0),
                ...
                (this.subscribe = function (t) {
                    ...
                    return (
                        ...
                        function () {
                            return (n.listeners = n.listeners.filter(function (
                                n
                            ) {
                                return n !== t;
                            }));
        ...
        pn = /*#__PURE__*/ (function () {
            ...
            return (
                ...
                (e.update = function (t) {
                    return t
                        ? (this.assign(n.fromPartialConfig(r({}, this, t))),
                          this)
                        : this;
                }),
    ...
    var vn = /*#__PURE__*/ (function (t) {
            ...
            return (
                    ...
                    for (var t, n = a(this.props.columns); !(t = n()).done; ) {
                        ...
                        void 0 === e.direction && (e.direction = 1),
                            1 !== e.direction &&
                                -1 !== e.direction &&
                                Vt.error(
                                    "Invalid sort direction " + e.direction
                                );
                    }
                }),
                ...
                (r.compareWrapper = function (t, n) {
                    for (
                        var e, r = 0, o = a(this.props.columns);
                        !(e = o()).done;
        ...
        yn = function (t, n, e) {
            return function (o) {
                var i = (o.sort ? [].concat(o.sort.columns) : []).find(
                    function (n) {
                        return n.index === t;
                    }
                );
            ...
            yt(
                function () {
                    var t =
                        ...
                        (c === K.ServerSort
                            ? new bn(
                                  r({ columns: l ? l.columns : [] }, a.server)
                              )
        ...
        var t = It(),
            ...
            s = xn(function () {
                try {
                    ...
                    var e = (function (e, o) {
                        try {
                            var i = Promise.resolve(t.pipeline.process()).then(
                                function (t) {
                                    n(
                                        (function (t) {
                                            return function (n) {
