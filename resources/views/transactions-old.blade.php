    ...
    <script>
        ...
        function loadTransaction() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    console.log('This is the data getalldata: ', data);
                    ...
                    sortedProjects.forEach(function(project) {
                        ...
                        project.particulars.forEach(function(particular, index) {
                            ...
                            console.log(particular.project_particular_quantity);
                            console.log(particular.project_particular_unit);
                            console.log(particular.project_particular_total);
                            ...
                            const materialTable = $(
                                `#MaterialTable_${particular.particular_id}`).DataTable({
                                responsive: true,
                                columns: [{
                                        title: "Material Name"
                                    },
                            ...
                            const laborTable = $(
                                `#LaborTable_${particular.particular_id}`).DataTable({
                                responsive: true,
                                columns: [{
                                        title: "Labor Name"
                                    },
                            ...
                            const equipmentTable = $(
                                `#EquipmentTable_${particular.particular_id}`).DataTable({
                                responsive: true,
                                columns: [{
                            ...
                            // Filter out details that should not be displayed in the grid
                            const dataMaterial = Object.values(particular.details.Materials);
                            const dataLabor = Object.values(particular.details.Labor);
                            const dataEquipment = Object.values(particular.details.Equipment);

                            // Populating Values to the Materials Table
                            dataMaterial.forEach(material => {
                                // Format price with commas and two decimal places
                                var formattedPrice = parseFloat(material.material_price)
                                    .toLocaleString(undefined, {
                                        minimumFractionDigits: 2,
                                        maximumFractionDigits: 2
                                    });

                                var materialAmount = (parseFloat(material
                                            .material_quantity) *
                                        parseFloat(
                                            material
                                            .material_price))
                                ...
                                materialTable.row.add([
                                    ...
                                    material.material_quarter,
                                    material.material_year,
                                    material.material_quantity,
                                    formattedPrice,
                                    materialAmount, // Calculating amount
                                    `<div class="text-center d-flex">
                                <button type="button" id="editButton" class="btn bg-success mr-2" onclick="editDetail('material', ${material.project_particular_material_id}, ${material.material_id}, '${material.material_name}', '${material.material_unit}', '${material.material_category_name}', ${material.material_price}, ${material.material_quantity}, ${material.particular_id}, '${material.material_quarter}', ${material.material_year}, ${material.material_price_id})">
                                    <i class="fa fa-edit"></i>
                                </button>
                                <button type="button" class="btn btn-danger btn-delete-material" onclick="deleteDetail('material', ${material.project_particular_material_id})">
                            ...
                            // Populating Values to the Labors Table
                            dataLabor.forEach(labor => {
                                // Format price with commas and two decimal places
                                var amount = (parseFloat(labor.labor_rate) * parseFloat(
                                        labor
                                        .labor_no_of_persons) * parseFloat(labor
                                        .labor_work_days))
                                    .toLocaleString(undefined, {
                                        minimumFractionDigits: 2,
                                        maximumFractionDigits: 2
                                ...
                                laborTable.row.add([
                                    labor.labor_name,
                                    labor.labor_no_of_persons,
                                    labor.labor_rate,
                                    labor.labor_work_days,
                                    amount,
                                    `<div class="text-center d-flex">
                            <button type="button" id="editButton" class="btn bg-success mr-2" onclick="editDetail('labor', ${labor.labor_id}, ${labor.labor_work_days}, ${labor.labor_no_of_persons}, ${labor.labor_rate}, '${labor.labor_name}', ${labor.particular_id})">
                                <i class="fa fa-edit"></i>
                            </button>
                            <button type="button" class="btn btn-danger btn-delete-material" onclick="deleteDetail('labor', ${labor.project_particular_labor_id})">
                                <i class="fa fa-trash-alt"></i>
                            </button>
                        </div>`
                                ]);
                            ...
                            // Populating Values to the Equipments Table
                            dataEquipment.forEach(equipment => {
                                // Format price with commas and two decimal places
                                var amount = (parseFloat(equipment.equipment_rate) *
                                        parseFloat(equipment.equipment_no_of_units) *
                                        parseFloat(equipment.equipment_work_days))
                                    .toLocaleString(undefined, {
                                        minimumFractionDigits: 2,
                                        maximumFractionDigits: 2
                                    });
                                ...
                                equipmentTable.row.add([
                                    ...
                                    amount,
                                    `<div class="text-center d-flex">
                                <button type="button" id="editButton" class="btn bg-success mr-2" onclick="editDetail('equipment', ${equipment.project_particular_equipment_id}, ${equipment.equipment_id}, '${equipment.equipment_name}', '${equipment.equipment_category_name}', '${equipment.equipment_model}', '${equipment.equipment_capacity}', ${equipment.equipment_rate}, ${equipment.equipment_no_of_units}, ${equipment.equipment_work_days}, ${equipment.particular_id})">
                                    <i class="fa fa-edit"></i>
                                </button>
                                <button type="button" class="btn btn-danger btn-delete-material" onclick="deleteDetail('equipment', ${equipment.project_particular_equipment_id})">
                                    <i class="fa fa-trash-alt"></i>
                                </button>
                            </div>`
                                ]);
                            ...
                            $('#MaterialTable_' + particular.particular_id).css('width', '');
                            $('#LaborTable_' + particular.particular_id).css('width', '');
                            $('#EquipmentTable_' + particular.particular_id).css('width', '');
                        });
        ...
        function createDetailCard(detailType, particular_id, particular_name, particular, totalAmounts) {
            ...
            var table = $('<table>', {
                ...
                id: detailType + 'Table_' + particular_id
            });
        ...
        function refreshAllData(particularId, detail_type) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // Iterate through each filtered project item
                    sortedProjects.forEach(function(project) {
                        // Filter the project particulars based on particularId
                        const sortedParticulars = project.particulars.filter(particular => particular
                            .particular_id === particularId);
                        // Sort the filtered particulars
                        sortedParticulars.sort((a, b) => a.particular_id - b.particular_id);
                        // Iterate through each sorted particular
                        sortedParticulars.forEach(particular => {
                            ...
                            $("#projectPartDetail_" + particularId).empty();

                            // Re-append the form variable
                            $("#projectPartDetail_" + particularId).append(
                                form);
                            ...
                            //Clear out the existing values of Data Table
                            var materialExistingRows = materialTable.rows().remove().draw(
                                false);
                            var laborExistingRows = laborTable.rows().remove().draw(false);
                            var equipmentExistingRows = equipmentTable.rows().remove().draw(
                                false);
        ...
        function deleteDetail(detailType, partID) {
            ...
            Swal.fire({
                ...
                icon: "warning",
                showCancelButton: true,
                cancelButtonColor: "#353535", // Cancel button color is green
                confirmButtonColor: "#FF0000", // Confirm button color is red
                confirmButtonText: "Yes, delete it!",
