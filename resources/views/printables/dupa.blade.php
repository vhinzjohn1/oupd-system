                        ...
                        if (project) {
                            ...
                            if (project.project_mode_of_implementation === 'By Admin') {
                                ...
                                project.particulars.forEach(function(particular, index) {
                                    ...
                                    var directCostTotal = particular.totalMaterialAmount +
                                        particular
                                    ...
                                    var vatTotal = (directCostTotal + indirectCostTotal) * (
                                        particular
                                        .vat / 100);
                                    var totalCostItem = directCostTotal + indirectCostTotal +
                                        vatTotal;
                                    ...
                                    var divHTML =
                                        ...
                                        '</td>' +
                                        '<td class="text-right">' + (particular.quantity ===
                                                null  ?
                                    ...
                                    if (materials.length > 0) {
                                        ...
                                        directCostTotal = totalMaterial + totalLabor +
                                            totalEquipment;
                                        ...
                                        divHTML +=
                                            '<tr>' +
                                            '<th colspan="4" class="text-start">A. TOTAL FOR MATERIALS</th>' +
                                            '<th class="text-end">' + materialCostDisplay +
                                            '</th>' +
                                            '</tr>';
                                    }
                                    // Create labor table
                                    ...
                                    if (equipment.length > 0) {
                                        ...
                                        divHTML +=
                                            '<tr>' +
                                            '<th colspan="4" class="text-start">C. TOTAL FOR EQUIPMENT</th>' +
                                            '<th class="text-end">' + equipmentCostDisplay +
                                            '</th>' +
                                            '</tr>';
                                    }
                                    ...
                                    var totalCostItem = directCostTotal + indirectCostTotal +
                                        vatTotal;
                                    var unitCostTotal1 = totalCostItem / particular.quantity;
                                    ...
                                    divHTML +=
                                        ...
                                        '<th class="text-right">' + (
                                            directCostTotal === 0 ? '-' : '₱' +
                                            numberWithCommas(directCostTotal
                                                .toFixed(2))) +
                                        //nakabold dapat
                                        '</th>' +
                                        '</tr>';
                                    divHTML +=
                                        ...
                                        '<th class="text-right">' + (
                                            indirectCostTotal === 0 ? '-' : '₱' +
                                            numberWithCommas(indirectCostTotal
                                    ...
                                    divHTML +=
                                        ...
                                        '<td class="text-right">' + (
                                            ocmTotal === 0 ? ' ' : '₱' + numberWithCommas(ocmTotal
                                                .toFixed(
                                                    2))) +
                                        '</td>' +
                                        '</tr>';
                                    ...
                                    divHTML +=
                                        ...
                                        '</td>' +
                                        '<td class="text-right">' + (
                                            cpTotal === 0 ? ' ' : '₱' + numberWithCommas(cpTotal
                                                .toFixed(
                                                    2))) +
                                        '</td>' +
                                        '</tr>';
                                    ...
                                    divHTML +=
                                        ...
                                        '</td>' +
                                        '<th class="text-right">' + (
                                            vatTotal === 0 ? ' ' : '₱' + numberWithCommas(vatTotal
                                                .toFixed(
                                                    2))) +
                                        //nakabold dapat ni
                                        '</th>' +
                                    ...
                                    divHTML +=
                                        ...
                                        '<th class="text-right">' +
                                        (totalCostItem === 0 ? '-' : '₱' + numberWithCommas(totalCostItem
                                            .toFixed(2))) +
                                        //nakabold dapat ni
                                        '</th>' +
                                        '</tr>';
                                    // console.log('unit:', unitCostTotal);
                                    // console.log('unit1:', unitCostTotal1);
                                    divHTML +=
                                        '<tr>' +
                                ...
                                project.particulars.forEach(function(particular, index) {
                                    ...
                                    divHTML +=
                                        ...
                                        '<td class="text-start"></td>' +
                                        '<td colspan="2" class="text-start">1. OVERHEAD, CONTINGENCY & MISCELLANEOUS (' +
                                        ((project.ocm === null || isNaN(project.ocm)) ? '0' :
                                            project
                                            .ocm) + '% of EDC)</td>' +
                                        '<td class="text-right">' + ((project.ocm === null || isNaN(
                                            project.ocm)) ? '0' : project.ocm) + '%' + '</td>' +
                                        '<td class="text-right">' + (
                                            ocmTotal === 0 ? ' ' : '₱' + numberWithCommas(ocmTotal
                                                .toFixed(
                                                    2))) +
                                    ...
                                    divHTML +=
                                        ...
                                        '<td class="text-start"></td>' +
                                        '<td colspan="2" class="text-start">2. CONTRACTORS PROFIT (' +
                                        ((project.contractors_profit === null || isNaN(project
                                                .contractors_profit)) ? '0' : project
                                            .contractors_profit) + '% of EDC)</td>' +
                                        '<td class="text-right">' + ((project.contractors_profit ===
                                                null || isNaN(project.ocm)) ? '0' : project
                                            .contractors_profit) + '%' +
                                        '</td>' +
                                        '<td class="text-right">' + (
                                            cpTotal === 0 ? ' ' : '₱' + numberWithCommas(cpTotal
                                    ...
                                    divHTML +=
                                        '<tr>' +
                                        '<th colspan="3" class="text-start">F. VAT (TOTAL ABOVE COST)</th>' +
                                        '<td class="text-right">' + ((project.vat === null || isNaN(
                                            project.vat)) ? '0' : project.vat) + '%' +
                                        '</td>' +
                                        '<th class="text-right">' + (
                                            vatTotal === 0 ? ' ' : '₱' + numberWithCommas(vatTotal
                                                .toFixed(
                                    ...
                                    divHTML +=
                                        ...
                                        '<th colspan="4" class="text-start">G. TOTAL COST ITEM (D+E+F)</th>' +
                                        '<th class="text-right">' + (
                                            totalCostItem === 0 ? '-' : '₱' + numberWithCommas(
                                                totalCostItem
                                                .toFixed(2))) +
                                        //nakabold dapat ni
                                        '</th>' +
